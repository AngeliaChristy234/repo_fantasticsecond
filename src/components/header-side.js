  ...
  render() {
    ...
    if(width > mqPX[2]) {
      return (
        ...
        >
          <img src={logo}/>
          <Menu.Item key='home'>Rumah</Menu.Item>
          <Menu.Item key='showcase'>Showcase</Menu.Item>
          <Menu.Item key='hubungikami'>Hubungi Kami</Menu.Item>
        </Menu>
      )
    }
